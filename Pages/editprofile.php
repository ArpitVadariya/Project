        ...
        if($old_pass == $prev_pass){
            if($new_pass != $confirm_pass){
                ...
                if($fileerror == 0){
                    ...
                    $updatequeryprofile = "UPDATE userdata SET imagepath='$destfile', username='$update_name', password='$confirm_pass' WHERE email='$old_email'";
                    $updateresultprofile = mysqli_query($conn, $updatequeryprofile);
